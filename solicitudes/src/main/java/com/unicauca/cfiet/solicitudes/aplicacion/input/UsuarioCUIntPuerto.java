...
public interface UsuarioCUIntPuerto {
     ...
     */
    Usuario crearUsuario(Usuario usuario, String tipoUsuario);
     ...
     */
    Usuario actualizarUsuario(String uuidUsuario, Usuario usuario);
     ...
     */
    Usuario cambiarContraseña(String uuidUsuario, String contraseña, String nuevaContraseña);
}
