 ...
 */
@Getter
public class ErrorGenericoExcepcion extends  RuntimeException{
    private final String mensaje;
    private final String codigo;

    public ErrorGenericoExcepcion(CodigoError codigo){
        super(codigo.getCodigo());
        this.mensaje = codigo.getMensaje();
        this.codigo = codigo.getCodigo();
    }

    public ErrorGenericoExcepcion(final String mensaje){
        super(mensaje);
        this.mensaje = CodigoError.ERROR_GENERICO.getMensaje();
        this.codigo = CodigoError.ERROR_GENERICO.getCodigo();
    }
}
